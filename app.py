...
def convert():
    ...
    try:
        ...
        # Send file to user
        return send_file(temp_output_path, mimetype='image/svg+xml', as_attachment=True, download_name='converted.svg')
...
if __name__ == '__main__':
    app.run(debug=True)from flask import Flask, request, send_file, render_template, jsonify
import os
from pixel_to_vector import pixel_to_vector
import tempfile
